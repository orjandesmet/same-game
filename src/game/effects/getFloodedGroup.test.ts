...
describe('getFloodedGroup', () => {
  it('should get all cell in the current column when no special creature', () => {
    ...
    const cuttingGroup = getFloodedGroup(false)(board, {rowIdx: 1, columnIdx: 1}, () => {});
  ...
  const board = createTestBoard(['RGBY', 'BGRY', 'YRGB', 'BBRB']);
    ...
    const cuttingGroup = getFloodedGroup(true)(board, {rowIdx: 1, columnIdx: 1}, () => {});
  ...
  const board = createTestBoard(['RGBY', 'BGRY', 'YRGB', 'BBRB']);
    ...
    const cuttingGroup = getFloodedGroup(true)(board, {rowIdx: 1, columnIdx: 0}, () => {});
  ...
  const board = createTestBoard(['RGBY', 'BGRY', 'YRGB', 'BBRB']);
    ...
    const cuttingGroup = getFloodedGroup(true)(board, {rowIdx: 1, columnIdx: 3}, () => {});
